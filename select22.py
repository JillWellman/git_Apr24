...
class State(Ruler):
	...
	def write_textfilex(self,text_object,text_filename):
...
class StatePath(Ruler):
	...
	def __init__(self) -> None:
		self.woG = WindowObject('G')
		print(self.woG.dtpl)
		self.woG.win = GraphWin(self.woG.name,*self.woG.dtpl)
	...
	def zoom_loop(self):
		...
		in_window(2.25*X,Y/2,im.graph_image_filename,ip.woG.win)

		# wd_graph = wd - X-X/5
		# in_window(wd_graph,Y/2,im.graph_image_filename,ip.woG.win)
